...
namespace MyFirstChapApplication
{
    /// <summary>
    ...
    public static class DAL
    {
        ...
        {
            string strConnect = @"Data Source=DESKTOP-T42J6PE\SQLEXPRESS;Initial Catalog=UserReg;Integrated Security=True"; // this is the connection string
